...
limit. Docker and Podman use CDI device IDs and select concrete NVIDIA CDI
devices for default and count-based GPU requests. VM gateways accept only one
GPU. In the API, these flags populate
